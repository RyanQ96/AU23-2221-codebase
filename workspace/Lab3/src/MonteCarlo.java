...
public final class MonteCarlo {
    ...
    public static void main(String[] args) {
        ...
        while (ptsInInterval < n) {
             ...
             */
            double x = 2 * rnd.nextDouble(); // make x within [0, 2]
            double y = 2 * rnd.nextDouble(); // make x within [0, 2]
            /*
         ...
         */
        double areaOfSquare = 2.0 * 2.0;
        double estimateAreaOfCircle = (areaOfSquare * ptsInSubinterval)
                / ptsInInterval;
        output.println("Estimate of area: " + estimateAreaOfCircle);
        /*
